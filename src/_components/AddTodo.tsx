...
export const AddTodo: React.FC<Props> = ({ setTodos, setIsLoading }) => {
	...
	return (
		<Box position={'fixed'} bottom={{ base: 4, lg: 8 }} right={{ base: 4, lg: 16 }}>
			<Flex
				alignItems={'center'}
				gap={2}
				onClick={() => {
				...
				cursor={'pointer'}
			>
				<AddIcon w={{ base: 8, lg: 12 }} h={{ base: 8, lg: 12 }} backgroundColor={'red.500'} color={'white'} borderRadius={'full'} p={2} />
				<Text fontSize={{ base: 'lg', lg: '3xl' }} fontWeight={'bold'} color='gray.700'>
					タスクを追加
				</Text>
			</Flex>
			<TodoModal
